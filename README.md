...
🔬 **Research**
- <code>2024</code> 지속가능한 도심 배달 서비스를 위한 데이터 기반의 전기 이륜차 배터리 교환소 위치 최적화. 대한산업공학회 추계학술대회 논문집.
- <code>2024</code> 스택 및 컨베이어 변수에 따른 강화학습 기반 3차원 적재 문제의 용적률 분석. 대한산업공학회 추계학술대회 논문집.
